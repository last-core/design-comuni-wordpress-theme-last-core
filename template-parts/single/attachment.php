...
<div class="cmp-icon-link">
    <a class="list-item icon-left d-inline-block" href="<?php echo dci_url_to_https($file_url); ?>" aria-label="Scarica Termini e condizioni di servizio (<?php echo $extension.' '.$size; ?>)" data-element="service-file">
