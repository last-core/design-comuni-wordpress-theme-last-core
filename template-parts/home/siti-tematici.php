...
?>
  ...
  <div class="container">
    ...
    <div class="pt-4 pt-lg-30">
      ...
      <button id="thematic-sites-btn" class="btn btn-primary btn-lg">Mostra tutti</button>
      <script>
        jQuery('#thematic-sites-btn').on("click", () => {
          jQuery('.thematic-card[hidden]').removeAttr('hidden');
          jQuery('#thematic-sites-btn').remove();
        })
      </script>
    </div>
  </div>
