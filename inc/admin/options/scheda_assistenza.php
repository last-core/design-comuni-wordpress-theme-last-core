...
function dci_register_scheda_assistenza_options()
{
    ...
    $assistenza_options->add_field(array(
        'id' => $prefix . 'richieste_options',
        'name'        => __('Richieste assistenza', 'design_comuni_italia'),
        'desc' => __('Configurazione del servizio richieste assistenza.', 'design_comuni_italia'),
        'type' => 'title',
    ));

    $assistenza_options->add_field(array(
        'id' => $prefix . 'email_assistenza',
        'name'        => __('Email dove inoltrare le richieste di assistenza', 'design_comuni_italia'),
        //'desc' => __( 'Numero Verde del Comune.' , 'design_comuni_italia' ),
        'type' => 'text_email',
    ));
}
