...
function dci_register_comune_options()
{
    ...
    $header_options->add_field(array(
        'id'    => $prefix . 'colore_tema',
        'name' => __('Colore tema', 'design_comuni_italia'),
        'desc' => __('Selezionare il colore del tema', 'design_comuni_italia'),
        'type'             => 'radio',
        'options'          => array(
            1 => __('Verde', 'design_comuni_italia'),
            2 => __('Rosso', 'design_comuni_italia'),
            3 => __('Blu', 'design_comuni_italia'),
            4 => __('Blu scuro', 'design_comuni_italia'),
            5 => __('Giallo', 'design_comuni_italia'),
        ),
    ));
}
