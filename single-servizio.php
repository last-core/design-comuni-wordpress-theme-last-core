 ...
 */
global $uo_id, $file_url, $pc_id, $hide_arguments;
...
<main>
    ...
    while (have_posts()) :
        ...
        $azione_secondaria_label = dci_get_meta("azione_secondaria_label");
                    ...
                    <div class="cmp-heading pb-3 pb-lg-4">
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <?php } ?>
                                <?php if ($azione_secondaria_link && $azione_secondaria_label) { ?>
                                    <button type="button" class="btn btn-outline-secondary fw-bold" onclick="location.href='<?php echo $azione_secondaria_link; ?>';">
                                        <span class=""><?php echo $azione_secondaria_label; ?></span>
                                    </button>
                                <?php } ?>
                            </div>
                                                ...
                                                <div id="collapse-one" class="accordion-collapse collapse show" role="region" aria-labelledby="accordion-title-one">
                                                    <div class="accordion-body">
                                                        <ul class="link-list" data-element="page-index">
                                                            ...
                                                            <?php if ($uo_id) { ?>
                                                                <li class="nav-item">
                                                                    <a class="nav-link" href="#unita-organizzativa">
                ...
                <div class="col-12 col-lg-8 offset-lg-1">
                    <div class="it-page-sections-container">
                        ...
                        <section class="it-page-section">
                            ...
                            <?php } ?>
                            <?php if ($uo_id) { ?>
                                <h2 class="mb-3" id="unita-organizzativa">Unità organizzativa responsabile</h2>
                                <div class="row">
                                    <div class="col-12 col-md-8 col-lg-6 mb-30">
                                        <div class="card-wrapper rounded h-auto mt-10">
                                            <?php
